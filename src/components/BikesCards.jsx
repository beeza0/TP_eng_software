...
const BikesCards = props => {
    ...
    const deleteBike = () => {
        axios.delete(`http://localhost:3001/deleteBike/${bikeData.id}`)
                .then(res => {
    ...
    <Paper className={classes.mainPaper}>
        <div  className="card mb-3 bike-card">
            <div className="card-body">
                ...
                {!isAdmin ? <div className="button">
                    {hasRented ? <div className="btn btn-primary">Rented</div> :
                    <button className="btn btn-primary" onClick = {() => newRent(bikeData)}>Rent</button>}
                </div>
                :
